...
3. Run the test suite locally — see [Testing](/contributing#testing)
...
Unit tests are required for any new utility, parser, or validator function. Integration tests are required for any new scraper. See [Testing](/contributing#testing) for the full guide.
