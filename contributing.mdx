...
3. Run the test suite locally — see [TESTING.md](https://github.com/mtauha/psxdata/blob/main/TESTING.md)
...
Unit tests are required for any new utility, parser, or validator function. Integration tests are required for any new scraper. See [TESTING.md](https://github.com/mtauha/psxdata/blob/main/TESTING.md) for the full guide.
