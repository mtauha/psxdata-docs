...
```bash
curl https://api.psxdata.io/health
```
...
<Tabs>
  <Tab title="Python">
    ...
    resp = requests.get("https://api.psxdata.io/health")
  ...
  <Tab title="JavaScript">
    ```javascript
    const resp = await fetch("https://api.psxdata.io/health");
...
```bash
curl "https://api.psxdata.io/stocks/ENGRO/historical?start=2025-01-01&end=2025-01-31"
```
...
<Tabs>
  <Tab title="Python">
    ...
    resp = requests.get(
        "https://api.psxdata.io/stocks/ENGRO/historical",
        params=params,
    )
    resp.raise_for_status()
    payload = resp.json()
  ...
  <Tab title="JavaScript">
    ```javascript
    const url = new URL("https://api.psxdata.io/stocks/ENGRO/historical");
...
```bash
curl https://api.psxdata.io/indices/KSE100
```
...
<Tabs>
  <Tab title="Python">
    ...
    resp = requests.get("https://api.psxdata.io/indices/KSE100")
    resp.raise_for_status()
    payload = resp.json()
  ...
  <Tab title="JavaScript">
    ```javascript
    const resp = await fetch("https://api.psxdata.io/indices/KSE100");
    if (!resp.ok) throw new Error(`HTTP ${resp.status}`);
    const payload = await resp.json();
...
```bash
curl -i https://api.psxdata.io/stocks/NOTREAL/quote
```
...
<Tabs>
  <Tab title="Python">
    ...
    try:
        resp = requests.get("https://api.psxdata.io/stocks/NOTREAL/quote")
        resp.raise_for_status()
  ...
  <Tab title="JavaScript">
    ```javascript
    const resp = await fetch("https://api.psxdata.io/stocks/NOTREAL/quote");
