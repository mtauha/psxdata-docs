...
```text
https://api.psxdata.io
```

<Note>
  The production domain is pending deployment confirmation. Update this value once the hosting environment is finalised.
</Note>
...
```bash
curl -s https://api.psxdata.io/market/summary
```
